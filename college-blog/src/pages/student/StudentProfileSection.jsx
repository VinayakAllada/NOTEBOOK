...
import StudentProfileEditSection from "../ProfileEditSection";
...
function Profile() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="p-10 w-[20 rem] bg-white border border-gray-200 shadow-2xl rounded-3xl flex flex-col items-center transition duration-300 hover:shadow-[0_10px_40px_rgba(0,0,0,0.1)] hover:border-blue-300">
        {/* Profile Picture and Name */}
        <div className="flex items-center gap-6 mb-10">
          <img className="w-32 h-32 rounded-full object-cover border-4 border-blue-400 shadow" />
